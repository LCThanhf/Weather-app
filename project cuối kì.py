...
lab = ttkbootstrap.Label(root, text = 'Enter a city', font = 'Helvetica, 21')
lab.pack(pady=11)
...
search_button = ttkbootstrap.Button(frame, text = '🔎', command=search, bootstyle="success-outline", padding="20 7.5")
...
location_label = tk.Label(root, font="Helvetica, 23")
location_label.pack()
